...
Detailed description of features can be seen in~\ref{fig:alvarez-features}.
...
where $S_*^n$ is maximum SB score and the parameter $\alpha$ $\in$ [0, 1] represents the fraction of the maximum Strong Branching score ($S_*^n$) that a variable must achieve to be assigned a label of '1'.
...
Detailed description of features can be seen in~\ref{fig:khalil-features}.
...
Detailed description of features can be seen in~\ref{fig:gasse-features}. % burası revize edilecek
